...
public interface ExtendedChunk {
    /**
     * {@link Chunk#setBlockState(BlockPos, IBlockState, boolean)} with the extra
     ...
     */
    @Nullable
    IBlockState setBlockState$worldEdit(BlockPos pos, IBlockState state, boolean moved, boolean update);
}
