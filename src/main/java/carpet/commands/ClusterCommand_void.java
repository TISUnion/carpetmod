...
public class ClusterCommand_void
{
    ...
    static {
        GLASS_LITERAL = literal("glass")
                ...
                .executes(ClusterCommand_void::cmdGlass)));
        AREA_LITERAL = literal("area")
                ...
                .executes(ClusterCommand_void::cmdArea)))));
        CALCULATE_LITERAL = literal("calculate")
                .then(argument("clusterNum", integer())
                .executes(ClusterCommand_void::cmdCalculate));
        MASK_LITERAL = literal("mask")
                .then(argument("mask", integer())
                .executes(ClusterCommand_void::cmdMask));
        LOAD_LITERAL = literal("load").executes(ClusterCommand_void::cmdLoad);
    }
