...
/**
 * Optimized variant of net.minecraft.util.math.shapes.IndirectMerger. This implementation works directly against
...
public final class LithiumDoublePairList implements IDoubleListMerger
{
    ...
    @Override
    public boolean forMergedIndexes(IDoubleListMerger.Consumer predicate) {
